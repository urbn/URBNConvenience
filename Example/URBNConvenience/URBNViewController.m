...
- (void)viewDidLoad
{
    ...
    UIImage *image = [URBNConvenience imageDrawnWithKey:@"imageKey" size:size block:^(CGRect rect, CGContextRef context) {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        UIImage *delayImage = [URBNConvenience imageDrawnWithKey:@"imageKey" size:size block:nil];
